            ...
            <div class="widgets widgets-footer row">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="single-widget widget-info">
                        <a class="widget-info-logo" href="index.html"><img src="resources/assets/images/logo.png"
                                                                           alt="logo"></a>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5">
                    <div class="tm-footer-payment">
                        <img src="resources/assets/images/payment-methods.png" alt="payment methods">
                    </div>
                </div>
            </div>
        </div>
